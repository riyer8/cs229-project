...
# Select features to include more columns
features = data[['Open', 'High', 'Low', 'Close', 'Volume', 'Daily Return']].values
...
input_dim = features.shape[1]  # Update input_dim to the number of feature columns
model = LSTMRegressor(input_dim=input_dim, hidden_dim=50, output_dim=1).to(DEVICE)
...
# Optional: Initialize weights for model
